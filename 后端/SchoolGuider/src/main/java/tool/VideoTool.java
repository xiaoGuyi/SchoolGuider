...
public class VideoTool {
    ...
    //视频文件路径
    private static String videoPath = "D:/IdeaTool/video";
 
    //视频帧图片存储路径
    public static String videoFramesPath = "D:/IdeaTool/img";
...
//                System.out.println(frame);
    ...
    public static void main(String[] args) {
        String videoFileName = "E:\\Java\\IDEA_Personal_File\\DataHacker\\src\\main\\webapp\\upload\\children_0001.mp4";
        grabberVideoFramer( videoFileName, "E:\\Java\\IDEA_Personal_File\\DataHacker\\frames" );
    }
    public static String getVideoPath() {
        return videoPath;
    }
    public static void setVideoPath(String videoPath) {
        VideoTool.videoPath = videoPath;
    }
}